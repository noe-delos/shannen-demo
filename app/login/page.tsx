  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden p-6">
        ...
        <div className="w-full h-full bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-800 rounded-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-center px-12 py-12 text-white h-full">
            <div className="max-w-md">
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                ...
                feedback personnalisé pour perfectionner vos techniques de
                vente.
              </p>
